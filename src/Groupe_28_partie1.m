...
% l'usine s'il est veut minimiser son cout. Elle affiche egalement sous
% forme de tableau ces resultats. Par ailleurs, elle affiche sous forme de
...
% sont les valeurs d'epsilon qui sont sur l'abcisse du graphique.
% 
% Sorties:
...
if nb_max_sous_traitant<0
    ...
    disp('les panneaux achetes doivent etre non-negatives.')
    disp('Le programme a ete arrete.')
    return
end
